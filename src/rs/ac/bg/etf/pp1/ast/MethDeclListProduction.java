...
public class MethDeclListProduction extends MethDeclList {

    private MethDeclList MethDeclList;
    private MethDecl MethDecl;

    public MethDeclListProduction (MethDeclList MethDeclList, MethDecl MethDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethDeclListProduction(\n");
